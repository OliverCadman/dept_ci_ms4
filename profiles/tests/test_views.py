...
from profiles.models import (UserProfile, AudioFile, Equipment,
                             UnavailableDate, Instrument, Genre)
from bookings.models import Review, Invitation, Booking
from profiles.views import ProfileView, edit_profile
...
# ----------------- Dashboard --------------------
    ...
    def test_filter_in_URL_query_from_booking_app(self):
        ...
        user_model = get_user_model()
        test_invite_sender = user_model.objects.create_user(
