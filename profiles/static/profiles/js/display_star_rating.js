$(document).ready(function () {
  ...
  */
  ...
  let variableEndpoint1 = currentPath.split("/")[3];
  let variableEndpoint2 = currentPath.split("/")[4];
  ...
  if (variableEndpoint1 && variableEndpoint2 !== "dashboard") {
    // If Profile Page
  ...
  function displayStarRating(hiddenRatingInputs, index, variableColour) {
    ...
    */
    ...
    if (variableEndpoint2 !== "find_a_dep") {
      /*
