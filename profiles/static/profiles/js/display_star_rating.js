$(document).ready(function() {
    ...
    */
    ...
    for (let i = 0; i < hiddenRatingInputs.length; i++) {
       ...
       let starRatingWrapper = hiddenRatingInputs[i].parentElement.children[2].children[0]
    ...
    */ 
    ...
    const starIconContainers = document.getElementsByClassName("header_star_icons");
