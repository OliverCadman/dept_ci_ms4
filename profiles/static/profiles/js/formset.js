...
$(document).ready(function() {
    ...
    function addMoreForms(e) {
        ...
        const currentForms = document.getElementsByClassName(e.currentTarget.formCopyClass)
        let currentFormCount = currentForms.length
        formCopyEmptyEl.setAttribute("id", `div_id_form-${currentFormCount}-${e.currentTarget.inputAttribute}`)
