...
urlpatterns = [
    ...
    path("edit_invitation/<int:invitation_id>", EditInvitationForm.as_view(), name="edit_invitation"),
    path("delete_invitation/<int:invitation_id>", delete_invitation, name="delete_invitation"), 
    ...
    path("finalize_tiertwo_booking/<int:job_id>", tier_two_booking_form, name="tier_two_booking_form"),
