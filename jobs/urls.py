...
from .views import (DepListView, JobListView, delete_job, post_job, register_interest,
                    get_interested_members, confirm_job_offer, EditJobView, delete_job, remove_offer)
...
urlpatterns = [
    ...
    path("remove_offer/<int:job_id>/<str:username>", remove_offer, name="remove_offer"),
    path("get_interested_members/<int:job_id>", get_interested_members, name="get_interested_members"),
